!(function (o) {
    ...
    o(function () {
        ...
        var e = o("#scroll-top"),
            t = document.querySelector(".header-menu-content"),
            i = t.offsetTop;
        o(window).on("scroll", function () {
            o(window).scrollTop() >= i ? ((document.body.style.paddingTop = t.offsetHeight + "px"), document.body.classList.add("fixed-nav")) : ((document.body.style.paddingTop = 0), document.body.classList.remove("fixed-nav")),
                300 <= o(this).scrollTop() ? e.show() : e.hide();
        }),
            o(document).on("click", "#scroll-top", function () {
                o("html, body").animate({ scrollTop: 0 }, 1e3);
            }),
            o(document).on("click", ".header-category ul li .dropdown-menu-item>li>.menu-collapse", function () {
            ...
            o(".view-more-carousel").owlCarousel({ loop: !0, items: 2, nav: !1, dots: !0, smartSpeed: 500, autoplay: !0, margin: 15, responsive: { 320: { items: 1 }, 768: { items: 2 } } }),
            o(".view-more-carousel2").owlCarousel({ loop: !0, items: 3, nav: !1, dots: !0, smartSpeed: 500, autoplay: !0, margin: 15, responsive: { 320: { items: 1 }, 768: { items: 3 } } }),
            o(".counter").counterUp({ delay: 20, time: 2e3 }),
            o(".video-play-btn").magnificPopup({ type: "video" }),
            ...
            o(".client-logo").owlCarousel({ loop: !0, items: 5, nav: !1, dots: !1, smartSpeed: 500, autoplay: !1, responsive: { 0: { items: 2 }, 481: { items: 3 }, 768: { items: 4 }, 992: { items: 5 } } }),
            o(".blog-post-carousel").owlCarousel({ loop: !0, items: 3, nav: !1, dots: !0, smartSpeed: 500, autoplay: !1, margin: 30, responsive: { 320: { items: 1 }, 992: { items: 3 } } }),
            ...
            o(document).on("click", ".portfolio-filter li", function () {
                ...
                o(".portfolio-list").isotope({ filter: e }), o(".portfolio-filter li").removeClass("active"), o(this).addClass("active");
            }),
            o(".portfolio-list").isotope({ itemSelector: ".single-portfolio-item", percentPosition: !0, masonry: { columnWidth: ".single-portfolio-item", horizontalOrder: !0 } }),
            o("[data-fancybox]").fancybox({ buttons: ["zoom", "share", "slideShow", "fullScreen", "download", "thumbs", "close"] }),
            (o.fancybox.defaults.animationEffect = "zoom"),
        o("#map").length && initMap("map", 40.717499, -74.044113, "images/map-marker.png"),
            o(document).on("click", ".input-number-increment", function () {
